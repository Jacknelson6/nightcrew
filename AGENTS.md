...
When you receive a heartbeat poll, don't just acknowledge it every time. Use heartbeats productively!

**Things to check (rotate through):**
- Project status — any builds failing? tests broken?
- Memory maintenance — anything to update?
- Pending work — can you make progress on something?
