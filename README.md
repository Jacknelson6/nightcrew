...
Memory systems, sub-agent patterns, and proactive workflows for [OpenClaw](https://github.com/anthropics/anthropic-quickstarts/tree/main/computer-use-demo) and [Clawdbot](https://github.com/clawdbot/clawdbot).
